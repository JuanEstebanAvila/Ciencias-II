...
public class MatrizAdyacencia implements GrafoUniversal {
    ...
    // Note: Emulando la matriz con listas subyacentes para compatibilidad,
    // pero idealmente se usaría double[][] para pesos.
    // Para simplificar la inyección de dependencias en este laboratorio,
    // mantenemos las listas de Nodos y Aristas sincronizadas.
